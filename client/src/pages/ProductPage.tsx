...
export default function ProductPage() {
  ...
  const fallbackImage = "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?w=1200&auto=format&fit=crop&q=80";
  ...
  const thumbs = product.images?.length
    ? product.images
        .map((img) => (typeof img === "string" ? img : img.thumb || img.url))
        .filter(Boolean)
    : images;
